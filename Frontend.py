...
if(not os.path.exists(os.path.dirname(__file__)+"\ProcessedRatings_110.csv")):
    urllib.request.urlretrieve("https://github.com/CoolSmit007/Product-Recommender/raw/main/ProcessedRatings_110.csv", filename="ProcessedRatings_110.csv")
if(not os.path.exists(os.path.dirname(__file__)+"\Processed_data.csv")):
    urllib.request.urlretrieve("https://github.com/CoolSmit007/Product-Recommender/raw/Product-Dataset/Processed_data.csv", filename="Processed_data.csv")
